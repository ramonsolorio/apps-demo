...
JOIN [dbo].[PROMOTION_DATA] p ON p.[STORE] = h.[LOCATION] and p.[LOAD_BATCH_ID] = h.[LOAD_BATCH_ID]
JOIN [dbo].[PROMOTION_DATA_DETAILS] d ON p.[STORE] = d.[STORE] and p.[LOAD_BATCH_ID] = d.[LOAD_BATCH_ID] and p.[PROMOTION] = d.[PROMOTION]
WHERE h.[LOCATION] = 924 and h.[LOAD_BATCH_ID] = 122176113 FOR XML PATH('Item'), ROOT('Items');